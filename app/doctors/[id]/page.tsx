...
import { ArrowLeft, Phone, Mail, Clock, Star, Users, Calendar, Activity, Printer, Download } from "lucide-react";
...
const patientStatusStyle: Record<string, string> = {
    Stable: "bg-green-100/80 text-green-700",
    Critical: "bg-red-100/80 text-red-700",
    Observation: "bg-yellow-100/80 text-yellow-700",
};
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-3">
                        {defaultSchedule.map((s: any, i: number) => (
                            <div key={i} className="flex items-center justify-between py-2.5 px-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-100 dark:border-gray-700/50">
                                ...
                                <span className={`text-[10px] px-2.5 py-1 rounded-full font-bold uppercase tracking-wider ${scheduleStyle[s.status]}`}>
                                    {s.status}
                                </span>
                            </div>
                        ))}
                ...
                <div className="glass-card p-6 animate-fade-in-up stagger-4">
                    ...
                    <div className="space-y-3 mb-6">
                        <div className="p-8 bg-white/50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 rounded-xl text-sm font-medium text-gray-400 text-center flex flex-col items-center justify-center">
